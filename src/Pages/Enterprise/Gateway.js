...
import { updateGatewayId } from "../../Slices/enterpriseDataSlice";
...
function Gateway() {
  ...
  const [displayEnterpriseUser, setDisplayEnterpriseUser] = useState("");
  ...
  useEffect(() => {
    ...
    fetchData();
  }, [token, trigger, gateway_response]);
  ...
  useEffect(() => {
    ...
    if (gateway_response && gateway_response.commonEnterpriseData) {
      ...
      setDisplayEnterpriseName(
        gateway_response.commonEnterpriseData.EnterpriseName
      );
      setDisplayStateName(gateway_response?.commonStateData.name);
      setDisplayLocationName(gateway_response.commonLocationData.LocationName);
      setDisplayEnterpriseUser(
        gateway_response.commonEnterpriseData.ContactInfo.Name
      );
    }
                  ...
                  {displayedData.map((item, rowIndex) => (
                    <tr className="text-gray-700 dark:text-gray-400">
                      <td className="px-4 py-3 text-sm">
                        <Link
                         onClick={() => handleInputChange(item, '/optimizer')}
                      ...
                      <td className="px-4 py-3 text-sm">
                        <div className="toggle_btn">
                          <input
                            ...
                            defaultChecked={checkboxStates1[item._id] || false}
                      ...
                      <td>
                        ...
                        <Link to="/gatewaydetails">
                          <button
                          onClick={() => handleInputChange(item, '/gatewaydetails')}
                            className="px-2 py-2 border-2 border-purple-600 text-purple-600 rounded-md"
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
